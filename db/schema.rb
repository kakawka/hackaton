...
ActiveRecord::Schema.define(version: 20141207084545) do
  ...
  add_index "license_agreement_acceptances", ["license_agreement_id"], name: "index_license_agreement_acceptances_on_license_agreement_id", using: :btree
